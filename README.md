...
- 추가로, game 서비스에 보내는 지급 요청 또한 APPROVE와 트랜잭션으로 묶지 않았습니다.
  ...
  - APPROVE 이후 에러 발생의 경우, 복잡한 롤백 로직으로 방지하기보다는 수동 대응이 적합하다고 생각합니다.
...
## 회고
- MSA가 가지는 명확한 이점과 같이 따라오는 불편함을 함께 예상해볼 수 있었습니다.
- 만약 보상 요청과 지급 상태간의 일관성이 필수였다면 SAGA, 2PC 등의 어려운 작업이 필요할 것으로 예상됩니다.
- 그래서 왜 MSA 도입을 조심스럽게 고민해야하는지, 몇몇분들이 MSA 도입을 왜 반대하는지를 조금 더 알게 되었습니다.
- 동시에 MSA가 가지는 이점인 유연성, 확장성을 체감해보고 싶은 마음이 더 커졌습니다.
- 이런 불편함을 감수할만큼의 상황은 언제인지, 그리고 그 효과는 어느 정도인지 느껴보고 싶다는 생각이 들었습니다.